...
const Dashboard = () => {
  ...
  const colors = ["#9333ea", "#d97706", "#d97706", "#dc2626", "#0284C7", "#0284c7", "#16a34a"]
    ...
    <div>
      <div className='max-w-7xl mx-auto px-4 py-8'>
        <motion.p
          ...
          className='text-2xl font-medium mb-6 bg-gradient-to-r from-slate-600 to-slate-700 bg-clip-text text-transparent sm:hidden'
        >
          Welcome, Joe Doe
        </motion.p>
