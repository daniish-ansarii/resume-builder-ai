...
// controller for ehancing a resume's professional summary
...
export const uploadResume = async (req, res) => {
    try {
        ...
        const systemPrompt = "You are an expert AI Agent to extra data from resume."
